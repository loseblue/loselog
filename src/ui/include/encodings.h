...
#ifndef LOSELOG_ENCODINGS_H
#define LOSELOG_ENCODINGS_H
  ...
  public:
    ...
    static QMenu* generate( QActionGroup* actionGroup )
    {
        ...
        QMenu* encodingsMenu = new QMenu(
            QApplication::translate( "loselog::mainwindow::menu", menu::encodingTitle ) );

        auto autoEncoding = encodingsMenu->addAction(
            QApplication::translate( "loselog::mainwindow::action", action::autoEncodingText ) );
        autoEncoding->setStatusTip(
            QApplication::translate( "loselog::mainwindow::action", action::autoEncodingStatusTip ) );
