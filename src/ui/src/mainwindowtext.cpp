...
// trayicon
const char* trayicon::trayiconTip = QT_TR_NOOP( "loselog log viewer" );

// action
const char* action::newWindowText = QT_TR_NOOP( "&New window" );
const char* action::newWindowStatusTip = QT_TR_NOOP( "Create new loselog window" );
...
const char* action::joinDiscordStatusTip
    = QT_TR_NOOP( "Join Loselog development community at Discord" );
const char* action::joinTelegramText = QT_TR_NOOP( "Join Telegram community..." );
const char* action::joinTelegramStatusTip
    = QT_TR_NOOP( "Join Loselog development community at Telegram" );
