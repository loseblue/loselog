    ...
    : QWidget( parent )
{
    ...
    timeBox_ = new loselog::DateTimeBox();
...
loselog::DateTimeBox::DateTimeBox()
    : QFormLayout()
    , timestamp_()
...
QString loselog::DateTimeBox::displayTime( const QString& text )
{
    bool isOk = false;
...
QString loselog::DateTimeBox::displayTime()
{
    if ( !timestamp_ ) {
        return QString{};
    }
