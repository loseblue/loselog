...
QTextCodec* EncodingDetector::detectEncoding( const loselog::vector<char>& block ) const
{
    ...
    QByteArray blockArray = QByteArray::fromRawData( block.data(), loselog::isize( block ) );
