...
class AbstractLogData : public QObject {
  ...
  public:
    ...
    loselog::vector<QString> getLines( LineNumber first_line, LinesCount number ) const;
    // Returns a set of lines with tabs expanded
    loselog::vector<QString> getExpandedLines( LineNumber first_line, LinesCount number ) const;
  ...
  protected:
    ...
    virtual loselog::vector<QString> doGetLines( LineNumber first_line, LinesCount number ) const = 0;
    // Internal function called to get a set of expanded lines
    virtual loselog::vector<QString> doGetExpandedLines( LineNumber first_line,
